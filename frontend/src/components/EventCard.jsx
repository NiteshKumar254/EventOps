...
// // // //   return (
// // // //     <div className="bg-gray-1200 shadow-lg rounded-2xl overflow-hidden border border-gray-500 hover:shadow-2xl transition-all duration-300">
...
// // // //           <span>🎫 Total Tickets: {event.totalSeats}</span>
// // // //           <span>
// // // //               📍 {event.venue}
// // // //           </span>
// // // //         </div>
...
// // // //             className="flex-1 bg-gray-700  text-white py-2 rounded-lg hover:bg-blue-500 transition"
// // // //           >
// // // //             📊 Attendance
// // // //           </button>
...
// // // // }
// // // import { useNavigate } from "react-router-dom";
// // // import { Calendar, Clock, Ticket, MapPin, BarChart3 } from "lucide-react";

// // // export default function EventCard({ event }) {
// // //   const navigate = useNavigate();

// // //   return (
// // //     <div className="bg-gray-900 shadow-lg rounded-2xl overflow-hidden border border-gray-700 hover:shadow-2xl transition-all duration-300">
// // //       <div className="p-4 text-white">
// // //         <h2 className="text-2xl font-semibold">{event.name}</h2>
...
//         className="bg-gray-1200 cursor-pointer shadow-lg rounded-2xl overflow-hidden border border-gray-500 hover:shadow-2xl hover:border-blue-400 transition-all duration-300"
//       >
//         <div className="p-4 text-white">
//           <h2 className="text-2xl font-semibold">{event.name}</h2>
