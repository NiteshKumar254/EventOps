...
// //phle ke phle pe chle jana thats okkk
// import Ticket from "../models/Ticket.js";
// import moment from "moment";
// import axios from "axios";
...
// // ✅ Helper: background me email bhejna
// const sendTicketEmail = async (email, ticket) => {
//   try {
//     console.log("Preparing ticket email for:", email);
...
//             Please show this email at the venue gate.
//           </p>
//         </div>
//       `,
//     });

//     console.log("Ticket email sent successfully via Resend");
//   } catch (error) {
...
// Brevo API client (SMTP nahi, HTTP API)
...
const sendTicketEmail = async (email, ticket) => {
  try {
    console.log("Sending ticket email via Brevo API to:", email);
    ...
    await apiInstance.sendTransacEmail({
      sender: {
        ...
        email: "noreply@brevo.com", // ✅ domain ki zarurat nahi
      },
      to: [{ email }],
      subject: "🎟️ Your Event Ticket",
      htmlContent: `
    ...
    console.log("Ticket email sent successfully via Brevo API");
  } catch (error) {
